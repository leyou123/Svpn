...
//    }
    ...
    // page
    self.categoryView.titles = @[NSLocalizedString(@"Basic", nil),NSLocalizedString(@"Premium", nil)];
...
//    refreshImage.tintColor = [UIColor whiteColor];
    ...
    titleLabel.text = NSLocalizedString(@"LineTrial", nil);  //设置标题
...
- (id<JXPagerViewListViewDelegate>)pagerView:(JXPagerView *)pagerView initListAtIndex:(NSInteger)index {
    ...
    if (index == 0) {
        listView.tableViewProxy.dataArray = QDConfigManager.shared.freeNodes.mutableCopy;
    } else {
