...
#import "QDFeatureView0.h"
#import "QDSizeUtils.h"

@implementation QDFeatureView0
...
//    }];
    ...
    image.image = [UIImage imageNamed:@"feature_many_nodes"];
    ...
    label.text          = NSLocalizedString(@"Feature_Title_0", nil);
    ...
    label1.text          = NSLocalizedString(@"Feature_Title_Sub_0", nil);
