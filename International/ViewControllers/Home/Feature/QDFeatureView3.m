...
#import "QDFeatureView3.h"
#import "QDSizeUtils.h"

@interface QDFeatureView3()

@property(nonatomic, strong) UILabel* subscribeLabel;

@end

@implementation QDFeatureView3
...
//    }];
    ...
    image.image = [UIImage imageNamed:@"feature_many_users"];
    ...
    label.text          = NSLocalizedString(@"Feature_Title_3", nil);
    ...
    label1.text          = NSLocalizedString(@"Feature_Title_Sub_3", nil);
