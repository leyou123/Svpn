...
#import "QDFeatureView1.h"
#import "QDSizeUtils.h"

@implementation QDFeatureView1
...
//    }];
    ...
    image.image = [UIImage imageNamed:@"feature_spead"];
    ...
    label.text          = NSLocalizedString(@"Feature_Title_1", nil);
    ...
    label1.text          = NSLocalizedString(@"Feature_Title_Sub_1", nil);
